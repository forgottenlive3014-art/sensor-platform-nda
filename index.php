...
$routeMap = [
    ...
    'profile/track-view' => ['AuthController', 'trackView'],
    ...
    'videos-educativos'     => ['MainController', 'videosEducativos'],
    ...
    'blog/comments'     => ['InteraccionController', 'listComments'],
    'blog/add-comment'  => ['InteraccionController', 'addComment'],
    'blog/delete-comment' => ['InteraccionController', 'deleteComment'],
    'blog/toggle-save'  => ['InteraccionController', 'toggleSave'],
    'blog/save-status'  => ['InteraccionController', 'saveStatus'],
    'blog/my-saved'     => ['InteraccionController', 'misGuardados'],
    'blog/my-comments'  => ['InteraccionController', 'misComentarios'],
    'blog/toggle-like'  => ['InteraccionController', 'toggleLike'],
    'blog/like-summary' => ['InteraccionController', 'getSummary'],
    ...
    'school/request-child-link'   => ['PadreController', 'requestChildLink'],
    'school/child-link-requests'  => ['PadreController', 'childLinkRequests'],
    'school/resolve-child-link'   => ['PadreController', 'resolveChildLinkRequest'],
