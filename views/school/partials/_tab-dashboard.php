        <div id="tab-dashboard" class="school-panel active">
            <div class="school-stats">
                ...
                <div class="school-stat">
                    <div class="school-stat-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div>
                    <div class="school-stat-number"><?= $stats['parents'] ?? 0 ?></div>
                    <div class="school-stat-label">Padres</div>
                </div>
                <div class="school-stat">
