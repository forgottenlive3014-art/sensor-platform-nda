...
<!-- BIG BANNER -->
<section class="dis-bigbanner" style="background-image:url('https://commons.wikimedia.org/wiki/Special:FilePath/ElSalvadorslide.jpg')">
  <div class="dis-bigbanner-overlay"></div>
  <div class="wrap dis-bigbanner-inner">
    <h2 class="dis-bigbanner-word">Deslizamientos</h2>
    <div class="dis-bigbanner-sub">
      <span class="dis-bigbanner-rule"></span>
      <div>
        <h3>¿Cómo se produce un deslizamiento?</h3>
        <p>La lluvia satura el suelo y añade peso, reduciendo la fricción entre capas hasta que la ladera deja de sostenerse.</p>
