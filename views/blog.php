...
$b_72 = <<<HTML
<p>Las primeras 72 horas tras un desastre son las más críticas: es el tiempo que puede pasar antes de que la ayuda externa llegue a tu zona. Prepararte para ese lapso no requiere dinero ni equipo especial, solo organización. Aquí tienes el plan completo.</p>
<h3>¿Por qué 72 horas?</h3>
...
<div><strong>La regla de oro:</strong> Agua, comida, luz, información y documentos. Si tu hogar tiene cubiertos esos cinco frentes para tres días, ya estás por delante de la mayoría.</div>
...
<h3>Practica antes de necesitarlo</h3>
...
<div><h4>Para recordar</h4><ul><li>3 litros de agua por persona al día, para 3 días.</li><li>Comida sin cocción y con fecha vigente.</li><li>Documentos en bolsa sellada + números en papel.</li><li>Punto de reunión y contacto acordados.</li><li>Ensaya el plan una vez al mes.</li></ul></div>
HTML;

$b_agachate = <<<HTML
<p>Cuando la tierra se mueve, tu cuerpo quiere correr. Pero los datos de miles de sismos demuestran que la mayoría de las lesiones ocurren al intentar desplazarse durante el movimiento. El protocolo internacional se resume en tres palabras: <strong>agáchate, cúbrete y agárrate</strong>.</p>
<h3>1. Agáchate</h3>
...
<div><strong>El mito de la puerta:</strong> Durante años se dijo que el marco de la puerta era lo más seguro. En construcciones modernas no lo es: las puertas oscilan y no protegen de objetos que caen. Mejor una mesa firme.</div>
<h3>Por qué no correr</h3>
...
<div><h4>Para recordar</h4><ul><li>Agáchate: al suelo, sobre manos y rodillas.</li><li>Cúbrete: cabeza y cuello, bajo mueble firme.</li><li>Agárrate: sujétate hasta que termine.</li><li>No corras ni uses el ascensor.</li></ul></div>
HTML;

$b_lluvias = <<<HTML
<p>En El Salvador la temporada de lluvias transforma quebradas tranquilas en corrientes mortales en minutos. La diferencia entre un susto y una tragedia suele estar en saber leer las señales a tiempo. Estas son las que nunca debes ignorar.</p>
<h3>El suelo ya está saturado</h3>
...
<h3>Señales de deslizamiento</h3>
...
<div><strong>Regla del agua en movimiento:</strong> Apenas 30 cm de agua corriente pueden arrastrar a una persona, y 60 cm a un vehículo. Nunca cruces una calle, puente o vado inundado, aunque parezca poco.</div>
<h3>Las quebradas crecen sin avisar</h3>
...
<div><h4>Para recordar</h4><ul><li>Suelo saturado = más riesgo en la siguiente lluvia.</li><li>Grietas, árboles inclinados y agua turbia: evacúa.</li><li>Nunca cruces agua en movimiento.</li><li>Sigue alertas del MARN por radio a pilas.</li></ul></div>
HTML;

$b_mochila = <<<HTML
<p>No necesitas gastar de más para tener una mochila de emergencia funcional. Estos son los diez objetos que cualquier hogar salvadoreño debería tener listos hoy, ordenados por prioridad.</p>
<h3>Los esenciales</h3>
<ol>
...
<div><strong>Dónde guardarla:</strong> Cerca de la salida principal, en un lugar que todos conozcan y puedan alcanzar a oscuras. De nada sirve una mochila perfecta si nadie sabe dónde está.</div>
<h3>Revísala dos veces al año</h3>
...
<div><h4>Para recordar</h4><ul><li>Agua y comida sin cocción primero.</li><li>Luz e información: linterna, radio y pilas.</li><li>Botiquín, documentos, silbato y efectivo.</li><li>Guárdala accesible y revísala 2 veces al año.</li></ul></div>
HTML;

$b_vecinos = <<<HTML
<p>En los primeros minutos de una emergencia, quien te rescata no es la ambulancia: son tus vecinos. Una colonia organizada salva más vidas que cualquier equipo que llegue después. Así puedes montar un plan comunitario en un fin de semana.</p>
<h3>Empieza por conocerse</h3>
...
<div><strong>El caso de Soyapango:</strong> Una colonia organizó su plan en un solo fin de semana: un mapa de la cuadra, una lista de vecinos por casa y un punto de reunión en la cancha. Cuando vino la siguiente alerta, evacuaron en orden y sin pánico.</div>
<h3>Acuerden un punto de reunión</h3>
...
<div><h4>Para recordar</h4><ul><li>Conózcanse: lista de vecinos y sus necesidades.</li><li>Roles definidos antes de la crisis.</li><li>Punto de reunión abierto y seguro.</li><li>Un simulacro comunitario al año.</li></ul></div>
HTML;

$b_simulacro = <<<HTML
<p>"Lo practicamos tantas veces que parecía un juego. Hasta que dejó de serlo." Así recuerda una maestra el día en que el simulacro que tantos estudiantes refunfuñaban terminó protegiéndolos de verdad.</p>
<h3>El simulacro que nadie tomaba en serio</h3>
...
<h3>El día que tembló de verdad</h3>
...
<div>"No tuvimos que decidir nada. Las manos de los niños ya iban hacia la cabeza antes de que yo abriera la boca."</div>
<h3>La lección</h3>
...
<div><h4>Para recordar</h4><ul><li>La repetición convierte el saber en reflejo.</li><li>En la emergencia real no hay tiempo de pensar.</li><li>Practica en casa una vez al mes.</li></ul></div>
HTML;

$b_punto = <<<HTML
<p>Si una emergencia separa a tu familia y se cae la señal del celular, ¿cómo se reencuentran? La respuesta es un acuerdo simple que toda familia debería tener y que no cuesta nada: el punto de reunión.</p>
...
<h3>Define dos puntos, no uno</h3>
...
<div><strong>Elige bien el lugar:</strong> Que sea abierto, conocido por todos y alejado de postes, muros y ventanales. Y que cada miembro sepa llegar allí por su cuenta, incluso de noche.</div>
<h3>Suma un contacto puente</h3>
...
<div><h4>Para recordar</h4><ul><li>Un punto cercano y uno lejano.</li><li>Lugares abiertos, seguros y conocidos por todos.</li><li>Un contacto puente fuera de la zona.</li><li>Escríbelo y repásalo dos veces al año.</li></ul></div>
HTML;
...
$n_2001_enero = <<<HTML
<p>El 13 de enero de 2001, un terremoto de magnitud 7.7 sacudió El Salvador, convirtiéndose en el más fuerte registrado en el país desde 1986. El epicentro fue frente a la costa de Usulután.</p>
...
<div><strong>Cifras oficiales:</strong> 844 muertos, 5,500 heridos y 150,000 damnificados. Las pérdidas económicas superaron los 300 millones de dólares.</div>
...
<h3>Una tragedia que marcó al país</h3>
...
<div><h4>Fuente</h4><ul><li><strong>Autor:</strong> Redacción La Prensa Gráfica</li><li><strong>Fecha:</strong> 13 de enero de 2001</li><li><strong>Enlace:</strong> <a href="https://www.laprensagrafica.com/" target="_blank">laprensagrafica.com</a></li></ul></div>
HTML;

$n_2005 = <<<HTML
<p>El 1 de octubre de 2005, el volcán Santa Ana (Ilamatepec), el más alto de El Salvador, entró en erupción, expulsando ceniza y lava que obligaron a evacuar a más de 2,000 personas.</p>
...
<div><strong>Evacuación masiva:</strong> 2,000 personas evacuadas de las comunidades aledañas al volcán. El gobierno de Antonio Saca declaró alerta roja en la zona.</div>
...
<div><h4>Fuente</h4><ul><li><strong>Autor:</strong> Redacción El Diario de Hoy</li><li><strong>Fecha:</strong> 1 de octubre de 2005</li><li><strong>Enlace:</strong> <a href="https://www.elsalvador.com/" target="_blank">elsalvador.com</a></li></ul></div>
HTML;

$n_2009 = <<<HTML
<p>El 8 de noviembre de 2009, la tormenta tropical Ida provocó inundaciones y deslaves en todo el país, dejando 198 muertos y más de 15,000 damnificados.</p>
...
<div><strong>Cifras de la tragedia:</strong> 198 muertos, 15,000 damnificados y pérdidas económicas que superaron los 200 millones de dólares.</div>
<div><h4>Fuente</h4><ul><li><strong>Autor:</strong> Redacción La Prensa Gráfica</li><li><strong>Fecha:</strong> 8 de noviembre de 2009</li><li><strong>Enlace:</strong> <a href="https://www.laprensagrafica.com/" target="_blank">laprensagrafica.com</a></li></ul></div>
HTML;

$n_2011 = <<<HTML
<p>El 10 de octubre de 2011, la depresión tropical 12-E dejó lluvias históricas en El Salvador, con acumulados de más de 500 mm en 48 horas, provocando inundaciones masivas y deslaves en todo el territorio.</p>
...
<div><strong>Una tormenta histórica:</strong> 34 muertos, 50,000 damnificados y pérdidas superiores a los 300 millones de dólares.</div>
<div><h4>Fuente</h4><ul><li><strong>Autor:</strong> Redacción El Diario de Hoy</li><li><strong>Fecha:</strong> 10 de octubre de 2011</li><li><strong>Enlace:</strong> <a href="https://www.elsalvador.com/" target="_blank">elsalvador.com</a></li></ul></div>
HTML;

$n_2020_amanda = <<<HTML
<p>El 30 de mayo de 2020, la tormenta tropical Amanda golpeó El Salvador en medio de la pandemia de COVID-19, dejando 31 muertos y más de 7,000 personas en albergues.</p>
...
<div><strong>La tormenta en tiempos de pandemia:</strong> 31 muertos, 7,000 albergados y pérdidas millonarias. La peor tormenta desde Mitch.</div>
<div><h4>Fuente</h4><ul><li><strong>Autor:</strong> Redacción El Diario de Hoy</li><li><strong>Fecha:</strong> 30 de mayo de 2020</li><li><strong>Enlace:</strong> <a href="https://www.elsalvador.com/" target="_blank">elsalvador.com</a></li></ul></div>
HTML;

$n_2020_cristobal = <<<HTML
<p>El 2 de junio de 2020, la tormenta tropical Cristóbal mantuvo las lluvias y la emergencia en El Salvador, apenas tres días después del paso de Amanda, saturando suelos y complicando la respuesta humanitaria.</p>
...
<div><strong>El doble golpe climático:</strong> Amanda y Cristóbal en menos de una semana. Suelos saturados. Más de 10,000 personas en albergues.</div>
<div><h4>Fuente</h4><ul><li><strong>Autor:</strong> Redacción La Prensa Gráfica</li><li><strong>Fecha:</strong> 2 de junio de 2020</li><li><strong>Enlace:</strong> <a href="https://www.laprensagrafica.com/" target="_blank">laprensagrafica.com</a></li></ul></div>
HTML;

$n_2022 = <<<HTML
<p>El 9 de octubre de 2022, el huracán Julia impactó El Salvador como tormenta tropical, dejando más de 4,000 evacuados y daños en carreteras, puentes y viviendas.</p>
...
<div><strong>Julia en El Salvador:</strong> 4,000 evacuados, 500 viviendas afectadas y daños en la infraestructura vial. Sin víctimas mortales.</div>
<div><h4>Fuente</h4><ul><li><strong>Autor:</strong> Redacción El Diario de Hoy</li><li><strong>Fecha:</strong> 9 de octubre de 2022</li><li><strong>Enlace:</strong> <a href="https://www.elsalvador.com/" target="_blank">elsalvador.com</a></li></ul></div>
HTML;

$n_2026_enero = <<<HTML
<p>El 10 de enero de 2026, un sismo de magnitud 4.1 frente a la costa de La Libertad fue percibido en San Salvador, Santa Tecla y Lourdes, sin reporte de daños materiales.</p>
...
<div><strong>Sismo de enero 2026:</strong> Magnitud 4.1. Epicentro frente a La Libertad. Sin daños. Percibido en la zona metropolitana.</div>
<div><h4>Fuente</h4><ul><li><strong>Autor:</strong> Redacción El Diario de Hoy</li><li><strong>Fecha:</strong> 10 de enero de 2026</li><li><strong>Enlace:</strong> <a href="https://www.elsalvador.com/noticias/nacional/sismo-marn/1258019/2026/" target="_blank">elsalvador.com</a></li></ul></div>
HTML;
...
.blog-title{ font-family:var(--fd); font-size:clamp(1.8rem,4.5vw,3rem); font-weight:900; line-height:1.04; color:var(--text,#fff); margin:0; letter-spacing:-.02em; }
...
.featured-content h2{ font-family:var(--fd); font-size:clamp(1.6rem,4vw,2.6rem); font-weight:900; color:#fff; margin:0 0 12px; line-height:1.08; letter-spacing:-.01em; }
...
.newsletter h3{ font-family:var(--fd); font-size:1.5rem; font-weight:900; color:var(--text,#fff); margin:0 0 8px; position:relative; letter-spacing:-.01em; }
...
.art-title{ font-family:var(--fd); font-size:clamp(1.7rem,4vw,2.6rem); font-weight:900; line-height:1.1; color:var(--text,#fff); margin:0 0 16px; letter-spacing:-.02em; }
...
/* ===== ARTÍCULO CUERPO ===== */
.art-body{ font-size: 1.08rem; line-height: 1.85; color: #5b6770; position: relative; z-index: 2; overflow-wrap: anywhere; }
.art-body a{ max-width: 100%; overflow-wrap: anywhere; word-break: break-word; }
.art-body .art-lead{ font-size:1.26rem; line-height:1.7; color:var(--text1,var(--text,#fff)); font-weight:500; margin:0 0 28px; }
.art-body h3{ font-size:1.28rem; font-weight:800; color:var(--text1,var(--text,#fff)); margin:28px 0 10px; line-height:1.25; letter-spacing:-.01em; }
.art-body p{ margin:0 0 18px; }
.art-body strong{ color:var(--text1,var(--text,#fff)); }
.art-body ol{ margin:0 0 18px; padding-left:0; list-style:none; counter-reset:s; }
.art-body ol li{ position:relative; padding:12px 0 12px 48px; border-bottom:1px dashed var(--border,#27272a); color:var(--text1,var(--text,#fff)); }
.art-body ol li::before{ counter-increment:s; content:counter(s); position:absolute; left:0; top:10px; width:30px; height:30px; border-radius:50%; background:linear-gradient(135deg,#f29f05,#c2441c); color:#fff; font-weight:800; font-size:.85rem; display:flex; align-items:center; justify-content:center; }
.art-body ul{ margin:0 0 18px; padding-left:20px; }
.art-body ul li{ margin-bottom:8px; }
.art-body div > strong{ display:inline; color:#f29f05; font-weight:800; }
.art-body div > h4, .art-body .art-takeaway h4, .art-takeaway h4{
  display: block;
  font-size: 1rem;
  font-weight: 800;
  color: #2e8b7f;
...
.art-body .art-key, .art-key{
  background: rgba(242, 159, 5, .07);
  border: 1px solid rgba(242, 159, 5, .22);
  border-left: 4px solid #f29f05;
  border-radius: 14px;
  padding: 18px 22px;
  margin: 28px 0;
}
.art-body .art-key strong, .art-key strong{
  display:block;
  color:#f29f05;
  font-size:1.08rem;
  font-weight:800;
...
.art-body .art-quote, .art-quote{
  font-size: 1.32rem;
  line-height: 1.5;
  font-weight: 700;
  color: var(--text2, #c4c4cc);
  border-left: 3px solid #d91a2a;
  padding: 8px 0 8px 18px;
  margin: 24px 0;
  font-style: italic;
}
.art-body .art-takeaway, .art-takeaway{
...
.art-body .art-takeaway h4, .art-takeaway h4{
  font-size: 1rem;
  font-weight: 800;
  color: #2e8b7f;
  margin: 0 0 12px;
...
.art-body .art-takeaway ul, .art-takeaway ul {
  margin: 0;
  padding-left: 20px;
  list-style: disc;
}
.art-body .art-takeaway li, .art-takeaway li{
  margin-bottom: 12px;
  color: var(--text2, #c4c4cc);
  line-height: 1.6;
}
.art-body .art-takeaway li::marker{ color: #2e8b7f; }
.art-body .art-takeaway a, .art-takeaway a{ text-decoration:underline; }

.art-more{ margin-top:54px; padding-top:32px; border-top:1px solid var(--border,#27272a); position:relative; z-index:2; }
.art-more h3{ font-family:var(--fd); font-size:1.3rem; font-weight:900; color:var(--text,#fff); margin:0 0 20px; letter-spacing:-.01em; }
