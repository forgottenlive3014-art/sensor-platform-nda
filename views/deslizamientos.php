...
document.addEventListener('DOMContentLoaded', function () {
    ndaInitTimeline('deslizamientos', [
        { year: '1982', title: 'Deslizamiento de Montebello', badge: '400,000 m³', region: 'San Salvador',
          desc: 'La madrugada del 19 de septiembre de 1982, una masa de aproximadamente 400,000 m³ de suelo y roca se desprendió de El Picacho, en el volcán de San Salvador, y sepultó el reparto Montebello. Marcó un antes y un después en la gestión de riesgo del país.',
          tags: [{ t: '400,000 m³', c: 'o' }, { t: 'Histórico', c: '' }],
          stats: [{ v: '1982', l: 'Año' }, { v: '400,000 m³', l: 'Material desprendido' }],
          img: 'assets/media/desastres/deslizamientos/1982-montebello.jpg' },
        { year: '1996', title: 'Deslizamientos de La Zompopera', badge: 'Recurrente', region: 'La Palma, Chalatenango',
          desc: 'Por más de 30 años, esta ladera de 500 m de ancho por 1,500 m de largo y pendientes de 70-80° ha registrado deslizamientos recurrentes. Los de 1996 y 1998 —este último durante el huracán Mitch— dañaron gravemente la infraestructura y las comunidades cercanas.',
          tags: [{ t: 'Recurrente', c: 't' }, { t: 'Huracán Mitch', c: 'o' }],
          stats: [{ v: '1996-98', l: 'Periodo crítico' }, { v: '70-80°', l: 'Pendiente' }],
          img: 'assets/media/desastres/deslizamientos/1996-zompopera.jpg' },
        { year: '2001', title: 'Deslizamiento de Las Colinas', badge: '~600 fallecidos', region: 'Santa Tecla',
          desc: 'El terremoto de magnitud 7.7 del 13 de enero de 2001 desprendió una masa de suelo de una ladera de unos 400 metros de altura, que cayó sobre la colonia Las Colinas y cubrió más de 6 cuadras de viviendas. Es el deslizamiento más mortífero en la historia reciente de El Salvador.',
          tags: [{ t: 'M 7.7', c: 'r' }, { t: '~600 muertos', c: 'r' }],
          stats: [{ v: '~600', l: 'Fallecidos' }, { v: '6+', l: 'Cuadras sepultadas' }, { v: '2001', l: 'Año' }],
