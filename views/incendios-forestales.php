...
document.addEventListener('DOMContentLoaded', function () {
    ndaInitTimeline('incendios', [
        { year: '2017', title: 'Gran temporada de incendios forestales', badge: '2,624 ha afectadas', region: 'San Vicente y otros departamentos',
          desc: 'La temporada seca registró un aumento de 29.3% frente a 2016. El fuego afectó bosques, matorrales y áreas agrícolas, con San Vicente entre los departamentos más golpeados.',
          tags: [{ t: 'Estacional', c: 'o' }, { t: 'Impacto ambiental', c: 'r' }],
          stats: [{ v: '29.3%', l: 'Incremento vs. 2016' }, { v: '2,624 ha', l: 'Área afectada' }, { v: '2017', l: 'Año del evento' }],
          img: 'assets/media/img/2017%201.jpg' },
        { year: '2017', title: 'Incendio en el parque Walter Thilo Deininger', badge: '800 manzanas afectadas', region: 'La Libertad · Área natural protegida',
          desc: 'El fuego alcanzó aproximadamente 800 manzanas del parque, afectando cobertura vegetal y hábitats de una de las principales áreas naturales protegidas de la costa.',
          tags: [{ t: 'Área protegida', c: 't' }, { t: 'Daño ambiental', c: 'r' }],
          stats: [{ v: '800 mz', l: 'Área afectada' }, { v: '2017', l: 'Año del evento' }],
          img: 'assets/media/img/2017%202.jpg' },
        { year: '2021', title: 'Incendio del Mercado Municipal de Santa Ana', badge: '2,000 puestos destruidos', region: 'Santa Ana · Incendio urbano',
          desc: 'El incendio del 10 de marzo destruyó aproximadamente 2,000 puestos de venta. El siniestro afectó los medios de vida de numerosos comerciantes y exigió la intervención de cuerpos de emergencia.',
          tags: [{ t: 'Incendio urbano', c: 'r' }, { t: 'Pérdidas económicas', c: 'o' }],
          stats: [{ v: '2,000', l: 'Puestos destruidos' }, { v: '10 mar', l: 'Fecha del evento' }, { v: '2021', l: 'Año' }],
          img: 'assets/media/img/santa%20ana.jpg' },
        { year: '2021', title: 'Incendio del Mercado San Miguelito', badge: 'Mercado histórico afectado', region: 'San Salvador · Centro histórico',
          desc: 'Un incendio de gran magnitud destruyó locales y puestos del histórico mercado, afectando a comerciantes y a una zona de alta concentración de personas y actividad económica.',
          tags: [{ t: 'Incendio urbano', c: 'r' }, { t: 'Centro histórico', c: 'o' }],
          stats: [{ v: '2021', l: 'Año del evento' }, { v: 'San Salvador', l: 'Ubicación' }],
          img: 'assets/media/img/miguelito.jpg' },
        { year: '2022', title: 'Emergencia Nacional por incendios', badge: 'Estado de Emergencia', region: 'Todo El Salvador · Temporada seca',
          desc: 'La combinación de vegetación seca, altas temperaturas y fuertes vientos elevó la propagación del fuego. La emergencia nacional reforzó la coordinación y la respuesta preventiva en todo el territorio.',
          tags: [{ t: 'Emergencia Nacional', c: 'o' }, { t: 'Alto riesgo', c: 'r' }],
          stats: [{ v: '2022', l: 'Año' }, { v: 'Nacional', l: 'Alcance' }],
